#!/usr/bin/env python3
"""Colab launcher for Stage 4M v1.0.3 RNG-safe resume recovery."""
...
RECOVERY_EXECUTABLE = "Stage4M_Resume_RNG_Device_Hotfix_v1_0_3.py"
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    print("=" * 100)
    print("STAGE 4M — RNG-SAFE RESUME LAUNCHER v1.0.3")
    print("=" * 100)
    mount_drive()
    ...
    if not pipeline.is_file():
        raise RuntimeError(f"Stage 4M v1.0.3 recovery executable missing: {pipeline}")
