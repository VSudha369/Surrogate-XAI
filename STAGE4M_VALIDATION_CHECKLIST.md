...
- [x] Exact resume binds RNG, loader, model, optimizer, scheduler, objective, architecture, teacher, benchmark, and predecessor hashes.
- [x] Teacher caches allow only Train Known and P0-P3.
- [x] Compression and minimum P0 fidelity gates block READY.
- [x] Stage-12 final transaction is interruption-safe and idempotent.
- [x] Preflight cannot train, cache targets, access Calibration Unknown/strict data, or create READY.
- [x] Validator contains at least 62 static/synthetic regressions.
