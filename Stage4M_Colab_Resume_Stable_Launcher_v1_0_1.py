#!/usr/bin/env python3
"""Colab launcher for Stage 4M v1.0.1 restart-safe checkpoint resume."""
...
RECOVERY_EXECUTABLE = "Stage4M_Resume_Stable_Predecessor_Hotfix_v1_0_1.py"
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    print("=" * 100)
    print("STAGE 4M — RESTART-SAFE RESUME LAUNCHER v1.0.1")
    print("=" * 100)
    mount_drive()
    ...
    if not pipeline.is_file():
        raise RuntimeError(f"Stage 4M recovery executable missing: {pipeline}")
    ...
    if args.preflight:
        ...
        if args.resume:
            print("[PASS] Resume requested; base Stage 4M resume=True is already active")
